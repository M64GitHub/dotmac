...
sketchybar --bar position=right width=24 blur_radius=30 color=0x00202020
...
sketchybar    --add item apple.logo left                                                      \
              --set apple.logo icon=􀣺  icon.padding_left=5 \
                               label.drawing=off                                              \
                               click_script="sketchybar -m --set \$NAME popup.drawing=toggle" \
                               popup.background.border_width=1                                \
                               popup.background.corner_radius=3                                \
                               popup.background.border_color=0xff404060                       \
			       popup.background.color=0xE0202040 \
                                                                                              \
